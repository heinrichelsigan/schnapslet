...
<script runat="server" language="C#">
    ...
    protected void OctalDump_ParameterChanged(object sender, EventArgs e)
    {
        Perform_Od();
    }
    ...
    <form id="form1" runat="server">
        <div style="nowrap; line-height: normal; height: 28pt; width: 100%; table-layout: fixed; font-size: medium; inset-block-start: initial">
            <span style="width:25%; vertical-align:middle; text-align: left; font-size: medium; height: 24pt" align="left" valign="middle">
                ...
                <asp:DropDownList style="font-size: medium; height: 24pt" ID="DropDown_HexWidth" runat="server" ToolTip="Hexadecimal width" AutoPostBack="True" OnSelectedIndexChanged="OctalDump_ParameterChanged">
            ...
            <span style="width:25%; vertical-align: middle; text-align: center; font-size: medium; height: 24pt" align="center" valign="middle">
                <span style="text-align: left; vertical-align: middle; font-size: medium; height: 24pt"> word width: </span>
                    <asp:DropDownList style="font-size: medium; height: 24pt" ID="DropDown_WordWidth" runat="server" ToolTip="Word with for bytes" AutoPostBack="True" OnSelectedIndexChanged="OctalDump_ParameterChanged">
                    <asp:ListItem>4</asp:ListItem>
            ...
            <span style="width:25%; vertical-align: middle; text-align: center; font-size: medium; height: 24pt" align="center" valign="middle">
                <span style="text-align: left; vertical-align: middle; font-size: medium; height: 24pt"> read bytes: </span>
                    <asp:DropDownList style="font-size: medium; height: 24pt"  ID="DropDown_ReadBytes" runat="server" ToolTip="Bytes to read on octal dump" AutoPostBack="True" OnSelectedIndexChanged="OctalDump_ParameterChanged">
                    <asp:ListItem>64</asp:ListItem>
            ...
            <span style="width:25%; vertical-align:middle; text-align: right; font-size: small; height: 24pt" align="right" valign="middle">
                ...
                <asp:TextBox style="font-size: small; height: 24pt" ID="TextBox_Seek" runat="server" ToolTip="seek bytes" MaxLength="8" Width="48pt" Height="24pt" AutoPostBack="True" OnTextChanged="OctalDump_ParameterChanged">0</asp:TextBox>
            </span>
        </div>
