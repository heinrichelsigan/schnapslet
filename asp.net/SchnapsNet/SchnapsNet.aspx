...
<body>
    <form id="form1" runat="server">        
        <div style="line-height: normal; height: 8%; width: 100%; font-size: larger; table-layout: fixed; inset-block-start: auto">                
            <span style="width:92%; height:8%; margin: 0px 0px 0px 0px; text-align: right; vertical-align:top; font-size: larger" align="right" valign="top">
                ...
                <asp:Button ID="bHelp" runat="server" ToolTip="Help" Width="12%"  Height="8%" Text="Help" style="font-size: x-large" OnClick="bHelp_Click" />
            </span>            
        </div>
        ...
        <div style="nowrap; line-height: normal; height: 10%; width: 100%; margin-top: 12px; font-size: medium; table-layout: fixed; inset-block-start: auto">
            ...
            <span style="width:15%; height:10%; margin-left: 0px; margin-top: 0px; text-align: left; font-size: medium">
                <asp:ImageButton ID="imOut0" runat="server" ImageUrl="~/cardpics/n0.gif" Width="10%" Height="12%" />
            </span>
