...
<body>
    <form id="form1" runat="server">        
        ...
        <div style="line-height: normal; vertical-align:middle; height: 8%; width: 100%; font-size: large; margin-top: 8px; background-color: #fefb56; table-layout: fixed; inset-block-start: initial">
            <span style="width:5%; vertical-align:middle; text-align: left; font-size: large; height: 8%;" align="left" valign="middle">
            ...
            <span style="width:76%; vertical-align:middle; text-align: left; font-size: large; height: 8%;" align="middle" valign="middle">            
                <asp:TextBox ID="tMsg" runat="server" ToolTip="text message" Width="75%" Height="8%" style="font-size: large">Short Information</asp:TextBox>
            </span>       
        </div>
