...
namespace SchnapsNet
{
    ...
    ".json");
        ...
        protected void CloseGame(PLAYERDEF whoCloses)
        {
            ...
            {
                string noStartMsg = ResReader.GetRes("nogame_started", Locale);
        ...
        protected void EndTurn()
        {
            ...
            if (tmppoints > 0)
            {
                sayMsg = ResReader.GetStringFormated("your_hit_points", Locale,                 
                    tmppoints.ToString());
                msgText = sayMsg + " " + ResReader.GetRes("click_continue", Locale);
            ...
            {
                sayMsg = ResReader.GetStringFormated("computer_hit_points", Locale, 
                    (-tmppoints).ToString());
                msgText = sayMsg + " " + ResReader.GetRes("click_continue", Locale);
