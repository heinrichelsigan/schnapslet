...
public class HelpDialog extends DialogFragment {
     ...
     *
     * @param idx Parameter1
     * @param ptx Parameter2
     * @return A new instance of fragment Help DialogFragment.
     */
    public static HelpDialog newInstance(int idx, int ptx) {
    ...
    public @NotNull Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_fragment_help, null))
