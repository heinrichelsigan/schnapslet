...
public class Player {
    public volatile boolean begins;    // does this Player begin ?
    public at.area23.schnapsen.Card hand[] = new at.area23.schnapsen.Card[5];  // Cards in Players Hand
    // not implemented yet !
    ...
    public volatile int colorHitArray[] = { 0, 0, 0, 0, 0 };
